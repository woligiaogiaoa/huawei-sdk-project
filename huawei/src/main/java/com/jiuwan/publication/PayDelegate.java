...
import com.jiuwan.publication.data.pay.OrderNumberBean;
...
import com.jiuwan.publication.util.OrderUtil;
...
import static com.jiuwan.publication.PublicationSDK.ORDER_CREATE;
   ...
   // private final String PAY_KEY="";
        ...
        OkGo.<LzyResponse<OrderNumberBean>>post(ORDER_CREATE)
                ...
                .execute(new JsonCallback<LzyResponse<OrderNumberBean>>() {
                    ...
                    public void onError(String errorMsg, int code) {
                        Toast.makeText(
                        PublicationSDK.getInstance().getApplication(),errorMsg,Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_BUY) {
            if (data == null) {
                Toast.makeText(PublicationSDK.getInstance().getActivity(), "error", Toast.LENGTH_SHORT).show();
                return;
            }
            PurchaseResultInfo purchaseResultInfo = Iap.getIapClient(
                    PublicationSDK.getInstance().getActivity()).parsePurchaseResultInfoFromIntent(data);
            switch(purchaseResultInfo.getReturnCode()) {
                case OrderStatusCode.ORDER_STATE_SUCCESS:
                    ...
                    try {
                        ...
                        PublicationSDK.deliverProduct(jsonObject.getString("purchaseToken"),
                                ...
                                new JsonCallback<SimpleResponse>() {
                                    ...
                                    public void onSuccess(Response<SimpleResponse> response) {
                                        if(response.body()!=null && response.body().code==0){
                                            consumeOwnedPurchase(PublicationSDK.getInstance().getActivity(),
                ...
                case OrderStatusCode.ORDER_STATE_CANCEL:
                    ...
                    Toast.makeText(PublicationSDK.getInstance().getActivity(), "user cancel", Toast.LENGTH_SHORT).show();
                    return;
                case OrderStatusCode.ORDER_PRODUCT_OWNED:
                    // The user has already owned the product.
                    Toast.makeText(PublicationSDK.getInstance().getActivity(), "你有订单尚未处理，正在为您处理", Toast.LENGTH_SHORT).show();
                ...
                default:
                    Toast.makeText(PublicationSDK.getInstance().getActivity(), "Pay failed", Toast.LENGTH_SHORT).show();
                    break;
            }
            return;
        }
    ...
    private void startPay(String storeProductId, String developerPayloadOrderNumber) {
        ...
        // 获取调用接口的Activity对象
        final Activity activity = PublicationSDK.getInstance().getActivity();
