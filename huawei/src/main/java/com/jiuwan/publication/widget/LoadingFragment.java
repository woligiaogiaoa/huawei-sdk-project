package com.jiuwan.publication.widget;
...
public class LoadingFragment extends DialogFragment {
    ...
    public static int getLayoutIdByName(String name) {
        return PublicationSDK.getInstance().getApplication().getResources().getIdentifier(name, "layout", PublicationSDK.getInstance().getApplication().getPackageName());
    }
}
